...
public class ExportLancamentosPdfQueryHandler : IRequestHandler<ExportLancamentosPdfQuery, Result<byte[]>>
{
    ...
    public ExportLancamentosPdfQueryHandler(
    ...
    public async Task<Result<byte[]>> Handle(ExportLancamentosPdfQuery request, CancellationToken cancellationToken)
    {
        // Fetch lancamentos
        ...
        // Generate PDF
        var bytes = _pdfGenerator.GenerateLancamentosReport(dtos, "lancamentos.pdf");
